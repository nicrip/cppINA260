...
typedef enum _conversion_time {
  INA260_TIME_140_us = 0x00,   ///< Measurement time: 140us
  INA260_TIME_204_us = 0x01,   ///< Measurement time: 204us
  INA260_TIME_332_us = 0x02,   ///< Measurement time: 332us
  INA260_TIME_558_us = 0x03,   ///< Measurement time: 558us
  INA260_TIME_1_1_ms = 0x04,   ///< Measurement time: 1.1ms (Default)
  INA260_TIME_2_116_ms = 0x05, ///< Measurement time: 2.116ms
  INA260_TIME_4_156_ms = 0x06, ///< Measurement time: 4.156ms
  INA260_TIME_8_244_ms = 0x07, ///< Measurement time: 8.224ms
 ...
 */
typedef enum _count {
  INA260_COUNT_1 = 0x00,    ///< Window size: 1 sample (Default)
  INA260_COUNT_4 = 0x01,    ///< Window size: 4 samples
  INA260_COUNT_16 = 0x02,   ///< Window size: 16 samples
  INA260_COUNT_64 = 0x03,   ///< Window size: 64 samples
  INA260_COUNT_128 = 0x04,  ///< Window size: 128 samples
  INA260_COUNT_256 = 0x05,  ///< Window size: 256 samples
  INA260_COUNT_512 = 0x06,  ///< Window size: 512 samples
  INA260_COUNT_1024 = 0x07, ///< Window size: 1024 samples
